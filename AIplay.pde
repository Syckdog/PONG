void AIplay() {
  ...
  if (difficult==1) {
    ...
    if (h1 == height/4) {
      if (dist(x, y, width/2 + 5, height/4 + 35) < 50) {
        vx = vx*-1;
        vy = vy*-1;
        w1 = width/3 - 30;
        h1 = height/2;
    ...
    if (h2 == height*3/4) {
      if (dist(x, y, width/2 + 5, height*3/4 + 35) < 50) {
        vx = vx*-1;
        vy = vy*-1;
        w2 = width*2/3 - 30;
        h2 = height/2;
    ...
    if (w1 == width/3 - 30) {
      if (dist(x, y, width/3 + 5, height/2 + 35) < 50) {
        vx = vx*-1;
        vy = vy*-1;
        w1 = width/2 - 30;
        h1 = height/4;
    ...
    if (w2 == width*2/3 - 30) {
      if (dist(x, y, width*2/3 + 5, height/2 + 35) < 50) {
        vx = vx*-1;
        vy = vy*-1;
        w2 = width/2 - 30;
        h2 = height*3/4;
    ...
    if (dist(x, y, xR, yR) < 125) {
      vx = (x-xR)*random(0.05, 0.15);
      vy = (y-yR)*random(0.05, 0.15);
      sample.trigger();
    }
  }
